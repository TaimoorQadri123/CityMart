                    ...
                    <!-- <div class="col-sm-12 col-xl-6"> -->
                        <div class="bg-light rounded h-100 p-4">
                            ...
                            <form method ="post" class="text-dark" enctype="multipart/form-data">
                                ...
                                <div class="mb-3">
                                    <label for="exampleInputPassword1" class="form-label"> Products Description</label>
                                ...
                                <div class="mb-3">
                                    <label for="exampleInputPassword1" class="form-label"> Products Price</label>
                                ...
                                <div class="mb-3">
                                    <label for="exampleInputPassword1" class="form-label"> Products Quantity</label>
